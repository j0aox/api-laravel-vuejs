...
const getSingleContato = async () => {
    let response = await axios.get(`/api/get_edit_contato/${props.id}`);
    form.value = response.data.contatos;
};
...
const updateContato = () => {
    ...
    axios
        .post(`/api/update_contato/${form.value.id}`, formData)
        .then((response) => {
            form.value.name = "";
            form.value.email = "";
            form.value.password = "";
        ...
        <div class="products__edit">
            ...
            >
                <div class="products__create__titlebar--item">
                    <h1 class="my-1">Ediat Contato</h1>
                </div>
                <div class="products__create__titlebar--item">
                    <button
